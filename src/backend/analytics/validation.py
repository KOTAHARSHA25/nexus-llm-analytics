...
class BootstrapValidator:
    ...
    def run_bootstrap(
        ...
        for _ in range(self.n_iterations):
            ...
            sample_indices = [self._rng.randint(0, n - 1) for _ in range(sample_size)]
        ...
        for key, values in all_metrics.items():
            ...
            ci_95_high = sorted_values[min(int(0.975 * n_vals), n_vals - 1)]
            ci_99_low = sorted_values[int(0.005 * n_vals)]
            ci_99_high = sorted_values[min(int(0.995 * n_vals), n_vals - 1)]
