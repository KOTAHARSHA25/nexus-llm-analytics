...
class UserPreferences(BaseModel):
    ...
    enable_intelligent_routing: bool = False  # OFF by default - respects user's manual model choice
...
class UserPreferencesManager:
    ...
    def load_preferences(self) -> UserPreferences:
        ...
        try:
            if self.preferences_file.exists():
                ...
                logging.debug("Created default user preferences")
        except Exception as e:
            logging.warning(f"Error loading preferences, using defaults: {e}")
            self._preferences = UserPreferences()
    ...
    def save_preferences(self, preferences: UserPreferences = None) -> bool:
        ...
        try:
            ...
            logging.debug("User preferences saved successfully")
            return True
        except Exception as e:
    ...
    def reset_preferences(self) -> bool:
        ...
        try:
            ...
            logging.error(f"[X] Error resetting preferences: {e}")
            return False
    ...
    def import_preferences(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logging.error(f"[X] Error importing preferences: {e}")
            return False
