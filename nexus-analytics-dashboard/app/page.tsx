      ...
      setResults({
        ...
        data: {
          ...
          insights: [
            ...
            { title: "Performance Metrics", description: "Average score improved to 87.3 points", impact: "high" },
          ],
          table: [
            { metric: "Total Records", value: "1,247", change: "+12%", trend: "up" },
            { metric: "Average Score", value: "87.3", change: "+5.2%", trend: "up" },
            { metric: "Completion Rate", value: "94.1%", change: "+2.1%", trend: "up" },
            { metric: "Error Rate", value: "0.8%", change: "-0.3%", trend: "down" },
          ],
          chart: {
