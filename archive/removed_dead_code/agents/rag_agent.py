...
class RAGAgent:
    ...
    def __init__(self, persist_directory="./chroma_db", llm_client=None):
    ...
    def retrieve(self, query, n_results=3):
        ...
        if not docs or len(docs) == 0:
            return {
                "query": query,
                "summary": f"No relevant documents found in the database for query: '{query}'. Please ensure documents have been uploaded and indexed.",
                "chunks": []
            }
