...
| [`../README.md`](../README.md) | **MAIN PROJECT OVERVIEW** (v2.1) | 10 min |
...
| Document | Purpose | Time to Read |
|----------|---------|--------------|
| [`archive/legacy_reports/`](archive/legacy_reports/) | Implementation logs & old reports | History |
| [`archive/research_drafts/`](archive/research_drafts/) | Research paper drafts | N/A |
...
2. `src/backend/core/engine/query_orchestrator.py` - Agent orchestration
...
- ✅ Renamed `DEVELOPMENT_NOTES.md` for clarity
- ✅ Verified all links
