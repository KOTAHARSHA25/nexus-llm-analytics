...
class CrewAIImportManager:
    ...
    def start_background_loading(self):
        ...
        if self._background_loader and self._background_loader.is_alive():
            logging.info("🔄 Background CrewAI loading already in progress")
            return
            
        logging.info("🚀 Starting background CrewAI import optimization...")
    ...
    def _background_import_crewai(self):
        ...
        try:
            logging.info("📦 Pre-loading CrewAI components in background...")
            ...
            logging.info(f"✅ CrewAI pre-loaded successfully in {self._import_status['load_duration']:.2f}s")
