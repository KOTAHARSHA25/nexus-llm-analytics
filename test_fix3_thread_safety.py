...
# Test 3: ModelInitializer Singleton
print("\n📝 Test 3: ModelInitializer thread safety")
print("-"*80)

from src.backend.agents.model_initializer import get_model_initializer

instances3 = []
def get_initializer():
    instance = get_model_initializer()
