...
from core.crewai_base import create_base_llm, create_analysis_tools
from core.sandbox import Sandbox
from core.chromadb_client import ChromaDBClient
from core.llm_client import LLMClient
from core.utils import friendly_error
from core.query_parser import AdvancedQueryParser, QueryIntent
...
class CrewManager:
    ...
    def __init__(self):
        ...
        # Create base LLM instances
        self.primary_llm = create_base_llm("ollama/llama3.1:8b")
        self.review_llm = create_base_llm("ollama/phi3:mini")
